...
<img src='walkthrough_part2.gif' title='Video Walkthrough' width=400 alt='Video Walkthrough' />
...
* Following along with online guides to implement Floating Action Bar.
...
Describe any challenges encountered while building the app.
* Actionbar, Twitter API Access, and infinite pagination.
